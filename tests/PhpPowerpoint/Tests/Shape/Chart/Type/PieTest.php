 ...
 *
 * @coversDefaultClass PhpOffice\PhpPowerpoint\Shape\Chart\Type\Pie
 */
class PieTest extends \PHPUnit_Framework_TestCase
{
    public function testData()
    {
        ...
        $this->assertInstanceOf('PhpOffice\\PhpPowerpoint\\Shape\\Chart\\Type\\Pie', $object->setData());
        $this->assertEmpty($object->getData());
        $this->assertInstanceOf('PhpOffice\\PhpPowerpoint\\Shape\\Chart\\Type\\Pie', $object->setData($array));
    ...
    public function testSeries()
    {
        ...
        $this->assertInstanceOf('PhpOffice\\PhpPowerpoint\\Shape\\Chart\\Type\\Pie', $object->addSeries(new Series()));
